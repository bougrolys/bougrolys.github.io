...
| Nom | Définition |
| --- | --- |
| Amortissement | Technique comptable consistant à constater la dépréciation d'un bien par rapport à la période précédente. Cet amortissement doit figurer au budget en section d'investissement via les articles dédiés. |
| Article | Sous-section d'un chapitre ou d'un compte. |
...
| Certificat administratif | Les certificats administratifs sont des documents qui permettent d'attester qu'une situation est réelle et que des actes ou des opérations sont exécutés conformément aux procédures requises ou non. |
| Chapitre ou compte | Sous-section d'une classe. |
| Chapitre globalisé | Ces chapitres qui ont un numéro à trois chiffres qui n'a plus rien à voir avec la numérotation du plan comptable général et la définition du chapitre qui liste explicitement tous les comptes participant à ce chapitre ; on parle alors de chapitre « globalisé ». Ces chapitres globalisés peuvent correspondre à des opérations réelles (mouvements de fonds effectifs), ou à des opérations dites « d'ordre » |
...
| Compte 1068 | Appelé aussi "Excédents de fonctionnement capitalisés" le compte 1068 permet de reverser une portion ou la totalité du reliquat de la section de fonctionnement du budget N-1 à la section d'investissement du budget N. |
| Compte administratif | Compte tenu par l'ordonnateur de la collectivité. Remplacé à l'avenir par le CFU dans le cadre de la fusion avec le compte de gestion. |
| Compte de gestion | Compte tenu par le comptable public. Remplacé à l'avenir par le CFU dans le cadre de la fusion avec le compte administratif. |
| Décision modificative | Acte budgétaire par lequel on modifie le budget primitif initialement prévu. |
| Dépenses imprévues | Dépenses mentionnées au budget sans ventilation associées et servant à gérer les imprévus. L'article 022 qui servait à les ventiler n'existent plus depuis le passage de la M14 à la M57. |
| Dépenses exceptionnelles | Dépenses imputées différemment en raison de leur caractère exceptionnel. |
...
| Ligne de trésorerie (ou crédit de trésorerie) | Crédit sollicitable pour des dépenses de fonctionnement à court terme. Doit être remboursé dans un délai de 3 mois. |
| Liquidation | Opération par laquelle la dépense devient certaine et exigible. Elle est arrêtée dans son montant définitif et devient susceptible d'être payée. |
| Mandatement ou ordonnancement | Action par laquelle l'ordonnateur ordonne le paiement d'une dépense au comptable public après avoir constaté le service fait.  |
